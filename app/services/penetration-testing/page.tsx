...
import { WhyImportance, GrowBusiness, OurServices, Faqs, WhatWeDo } from '@/data/penetrationTesting'

import ButtonDark from "@/components/widgets/button_dark";
import Industries from "@/components/industries";
import MethodologyPenetrationTesting from "@/components/methodology/penetrationTesting";
...
export const metadata: Metadata = {
    title: 'Penetration Testing Services | ThreatBlock',
    description: 'Identify and fix vulnerabilities before attackers do. Our expert penetration testing services simulate real-world attacks to secure your network, web, and mobile apps.',
    keywords: 'penetration testing, pentesting services, ethical hacking, vulnerability assessment, security testing'
};
                    ...
                    <div className="lg:w-9/12 w-11/12 lg:flex lg:h-[auto] h-[30vh] justify-around items-center mx-auto z-10 relative gap-10">
                        ...
                        <div className="lg:w-6/12 w-full lg:h-[90vh] h-[35vh] lg:mx-0 relative">
                            <MotionDiv
                                ...
                                <Image src='/images/services/pt.svg' height={100} width={1000} alt="about" />
                            </MotionDiv>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:w-9/12 w-11/12 mx-auto flex justify-between items-center gap-10 mb-20">
                    ...
                    <div className="lg:w-8/12 flex flex-col gap-2">
                        ...
                        <MotionH2
                            ...
                            Enhance Penetration Testing: Comprehensive Vulnerability Discovery
                        </MotionH2>
                        <MotionP
                            initial={{ x: -50, opacity: 0 }}
                            whileInView={{ x: 0, scale: 1, opacity: 1 }}
                            ...
                            className="text-gray-700 lg:text-xl text-lg">Penetration Testing simulates real-world attacks to uncover vulnerabilities across networks, apps, and cloud systems. Our service prevents breaches averaging $4.5 million by identifying and mitigating risks.
                        </MotionP>
            ...
            <section className="lg:w-9/12 w-11/12 mx-auto flex lg:flex-row flex-col justify-between items-center gap-10 lg:mb-24 mb-20">
                ...
                <div className="lg:w-7/12 flex flex-col gap-2 items-start justify-start">
                    ...
                    <MotionP
                        ...
                        className="text-gray-700 lg:text-xl text-lg mb-2">Untested systems are vulnerable to exploits like ransomware or data theft. Penetration Testing ensures:</MotionP>
                ...
                <div className="lg:w-9/12 w-11/12 mx-auto mb-10 lg:flex justify-center items-center gap-10">
                    ...
                    <div className="lg:w-6/12 w-full lg:order-first">
                        ...
                        <MotionP
                            ...
                            className="text-gray-700 lg:text-xl text-lg mb-5">Proven experts, reducing risks by 80% for enterprises.
                        </MotionP>
                    ...
                    <MotionDiv
                        ...
                        <div className="p-4 lg:flex gap-2 bg-gradient-to-b from-white to-[#fff6f6]">
                            <div className="lg:w-8/12 flex flex-col lg:justify-center lg:items-start items-center lg:mb-0 mb-10">
                                ...
                                <p className="text-gray-700 lg:text-xl text-lg mb-10">Download our “Penetration Testing Guide” or schedule a consultation.</p>
