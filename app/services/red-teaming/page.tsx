...
import { WhyImportance, GrowBusiness, OurServices, Faqs } from '@/data/redTeaming'
// Using more intuitive icons for open/close states

import ButtonDark from "@/components/widgets/button_dark";
import Industries from "@/components/industries";
import MethodologyRedTeaming from "@/components/methodology/redTeaming";

import { Metadata } from 'next';
import Accordion from "@/components/accordian";

export const metadata: Metadata = {
    title: 'Red Teaming Services | Adversary Simulation | ThreatBlock',
    description: 'Test your organization\'s real-world defense. Our red teaming operations simulate advanced persistent threats (APTs) to challenge your people, processes, and tech.',
    keywords: 'red teaming services, adversary simulation, apt simulation, cyber defense testing, security operations testing'
};
...
export default function RedTeaming() {
    ...
    return (
        <>
                    ...
                    <div className="lg:w-9/12 w-11/12 lg:flex lg:h-[auto] h-[30vh] justify-around items-center mx-auto z-10 relative gap-10">
                        ...
                        <div className="lg:w-6/12 w-full lg:h-[90vh] h-[35vh] lg:mx-0 relative">
                            <MotionDiv
                                ...
                                <Image src='/images/services/red-teaming.svg' height={100} width={1000} alt="about" />
                            </MotionDiv>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:w-9/12 w-11/12 mx-auto flex justify-between items-center gap-10 mb-20">
                    ...
                    <div className="lg:w-8/12 flex flex-col gap-2">
                        ...
                        <MotionH2
                            ...
                            Master Red Teaming: Simulating Real-World Adversaries
                        </MotionH2>
                        <MotionP
                            initial={{ x: -50, opacity: 0 }}
                            whileInView={{ x: 0, scale: 1, opacity: 1 }}
                            ...
                            className="text-gray-700 lg:text-xl text-lg">Red Teaming emulates sophisticated attackers to test your defenses end-to-end. Our service uncovers gaps in people, processes, and technology to build true resilience.
                        </MotionP>
            ...
            <section className="lg:w-9/12 w-11/12 mx-auto flex lg:flex-row flex-col justify-between items-center gap-10 lg:mb-24 mb-20">
                ...
                <div className="lg:w-7/12 flex flex-col gap-2 items-start justify-start">
                    ...
                    <MotionP
                        ...
                        className="text-gray-700 lg:text-xl text-lg mb-2">Traditional tests miss adaptive threats. Red Teaming reveals how attackers chain exploits, with breaches costing $4.9 million on average. It's essential to:</MotionP>
                ...
                <div className="lg:w-9/12 w-11/12 mx-auto mb-10 lg:flex justify-center items-center gap-10">
                    ...
                    <div className="lg:w-6/12 w-full lg:order-first">
                        ...
                        <MotionP
                            ...
                            className="text-gray-700 lg:text-xl text-lg mb-5">MITRE experts, reducing risks by 80%.
                        </MotionP>
            ...
            {/* FAQs */}
            <section className="w-full bg-red-50 lg:h-[80vh] lg:py-0 py-20 lg:mb-24 mb-20 flex flex-col justify-center items-center">
            ...
            <section className="lg:w-9/12 w-11/12 mx-auto flex lg:flex-row flex-col justify-between items-center gap-10 lg:mb-24 mb-20">
                <div className="lg:w-6/12 flex flex-col gap-2 items-start justify-start">
                    ...
                    <MotionP
                        ...
                        className="text-gray-700 lg:text-xl text-lg mb-2">Pair with:</MotionP>
                    ...
                    <MotionDiv
                        ...
                        <div className="p-4 lg:flex gap-2 bg-gradient-to-b from-white to-[#fff6f6]">
                            <div className="lg:w-8/12 flex flex-col lg:justify-center lg:items-start items-center lg:mb-0 mb-10">
                                ...
                                <p className="text-gray-700 lg:text-xl text-lg mb-10">Download “Red Teaming Guide” or consult.</p>
