...
export const metadata: Metadata = {
    title: 'Cyber Threat Intelligence Services | ThreatBlock',
    description: 'Stay ahead of attackers with actionable threat intelligence. We provide tailored reports on active threats, actor profiling, and indicators of compromise (IoCs).',
    keywords: 'threat intelligence, cyber threat intelligence, ioc, threat hunting, dark web monitoring, cyber risk'
};
                ...
                <div className="lg:w-9/12 w-11/12 mx-auto flex justify-between items-center gap-10 mb-20">
                    ...
                    <div className="lg:w-8/12 flex flex-col gap-2">
                        ...
                        <MotionP
                            ...
                            className="text-gray-700 lg:text-xl text-lg">Threat Intelligence provides actionable insights into adversaries, vulnerabilities, and attack trends, enabling proactive defense against cyber threats. Our service empowers organizations to anticipate and neutralize risks before they materialize.
                        </MotionP>
            ...
            <section className="lg:w-9/12 w-11/12 mx-auto flex lg:flex-row flex-col justify-between items-center gap-10 lg:mb-24 mb-20">
                ...
                <div className="lg:w-7/12 flex flex-col gap-2 items-start justify-start">
                    ...
                    <MotionP
                        ...
                        className="text-gray-700 lg:text-xl text-lg mb-2">With cyber attacks costing businesses an average of $4.9 million per breach, staying ahead of threats like ransomware, APTs, and zero-days is critical. Threat Intelligence helps you:</MotionP>
                ...
                <div className="lg:w-9/12 w-11/12 mx-auto mb-10 lg:flex justify-center items-center gap-10">
                    ...
                    <div className="lg:w-6/12 w-full lg:order-first">
                        ...
                        <MotionP
                            ...
                            className="text-gray-700 lg:text-xl text-lg mb-5">Our analysts, leveraging MITRE ATT&CK expertise, have helped enterprises reduce threat exposure by 80% on average.
                        </MotionP>
