...
export const metadata: Metadata = {
    title: 'Web Application Penetration Testing | ThreatBlock',
    description: 'Secure your websites and web apps from SQL injection, XSS, and other critical flaws (OWASP Top 10). Our detailed web app pentesting ensures your data is safe.',
    keywords: 'web application pentesting, web app security, owasp top 10, sql injection testing, xss testing, website security test'
};
                ...
                <div className="lg:w-9/12 w-11/12 mx-auto flex justify-between items-center gap-10 mb-20">
                    ...
                    <div className="lg:w-8/12 flex flex-col gap-2">
                        ...
                        <MotionP
                            ...
                            className="text-gray-700 lg:text-xl text-lg">Web apps are the digital face of your organization, vulnerable to attacks like XSS and SQL injection. Our Web Application Penetration Testing exposes flaws in code, logic, and configurations to protect your online presence.
                        </MotionP>
            ...
            <section className="lg:w-9/12 w-11/12 mx-auto flex lg:flex-row flex-col justify-between items-center gap-10 lg:mb-24 mb-20">
                ...
                <div className="lg:w-7/12 flex flex-col gap-2 items-start justify-start">
                    ...
                    <MotionP
                        ...
                        className="text-gray-700 lg:text-xl text-lg mb-2">Web apps are constant targets for exploits that steal data or hijack sessions. A vulnerability like broken authentication can lead to massive breaches, with costs averaging $4.5 million. Testing is key to:</MotionP>
